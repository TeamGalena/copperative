package galena.coopperative.item;
...
public class PatinaItem extends Item {
    ...
    public @NotNull InteractionResult useOn(UseOnContext ctx) {
        ...
        if (block instanceof WeatheringCopperObserverBlock && WeatheringCopperObserverBlock.getNext(block).isPresent()) {
            Block nextWeatherBlock = WeatheringCopperObserverBlock.getNext(block).get();
            apply(world, player, stack, hand, pos, state, nextWeatherBlock);
        }
